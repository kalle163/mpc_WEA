...
uint32_T _Simulation_der_ReglerMachineNumber_;

/* Function Declarations */

/* Function Definitions */
void Simulation_der_Regler_initializer(void)
{
}

void Simulation_der_Regler_terminator(void)
{
}
...
unsigned int sf_Simulation_der_Regler_process_check_sum_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1959947299U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3195896838U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3437408642U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(239527505U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3238058453U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4163815062U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1790145569U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4113106452U);
  }
...
unsigned int sf_Simulation_der_Regler_autoinheritance_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
...
unsigned int sf_Simulation_der_Regler_get_eml_resolved_functions_info( int nlhs,
...
unsigned int sf_Simulation_der_Regler_third_party_uses_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_Simulation_der_Regler_jit_fallback_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_Simulation_der_Regler_updateBuildInfo_args_info( int nlhs,
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void Simulation_der_Regler_debug_initialize(struct SfDebugInstanceStruct*
  debugInstance)
{
  ...
  sf_debug_set_machine_data_thresholds(debugInstance,
    _Simulation_der_ReglerMachineNumber_,0);
}

void Simulation_der_Regler_register_exported_symbols(SimStruct* S)
{
}
...
void unload_Simulation_der_Regler_optimization_info(void);
mxArray* load_Simulation_der_Regler_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "Simulation_der_Regler", "Simulation_der_Regler");
